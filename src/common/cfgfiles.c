...
const struct prefs vars[] =
{
	...
	{"gui_tray_onexit", P_OFFINT (hex_gui_tray_onexit), TYPE_BOOL},
	{"gui_tray_onminimize", P_OFFINT (hex_gui_tray_onminimize), TYPE_BOOL},
	...
	{"input_balloon_trayonly", P_OFFINT (hex_input_balloon_trayonly), TYPE_BOOL},
