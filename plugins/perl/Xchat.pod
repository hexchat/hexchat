...
L<find_context|"xchat::find_context(_[$channel,__[$server]]_)">.
...
=item *
C<$context>	-	context value as returned from L<get_context|"xchat::get_context()_">,L<find_context|"xchat::find_context(_[$channel,__server]]_)"> or one
